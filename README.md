...
This repository performs inference for image quality assessment on authentically distorted camera captured images using a pre-trained multimodal model.
...
The model weights file iter_5673.tar is [inside train folder](https://drive.google.com/file/d/1P1XwUMmHdW0M1J80X7ErNd_bu2X8OjrO/view?usp=sharing). You need to download the Run0004 folder. 
```python
